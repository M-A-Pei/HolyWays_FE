            ...
            <div style={{ height: "80vh", backgroundColor: "#bf2626" }} className="row m-0">
                <div className="col-lg-12 d-flex flex-wrap m-0">
                    ...
                    <div className="col-lg-5 col-md-12">
                        <img src={image_1} width="70%" style={{ marginLeft: "auto", display: "relative", transform: "translate(40%, 20%)" }} />
                    </div>
                </div>
            </div>
            <div className="row m-0 p-3 mb-5">
                <div className="col-lg-12 d-flex flex-wrap">
                    <div className="col-lg-5 col-md-12" style={{ display: "relative", transform: "translate(0%, -12%)" }}>
                    ...
                    <div className="col-lg-7 col-md-12 d-flex flex-column gap-3" style={{ display: "relative", transform: "translate(0%, 10%)" }}>
                        <h1 className="fw-bold">Your fund is very helpful for people affected by forest fires is Kalimantan</h1>
